<?php
  ...
  if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE `publicacionesUS` 
    SET 
    tituloUS=:titulo,
    fecha=:fecha,
    contenidoUS=:contenido,
    resumenUS=:resumen WHERE ID= :ID;");
    ...
    if ($_FILES['imagen']['name']!=""){  
      ...
      $sentencia = $conexion->prepare("SELECT nom_imagen FROM publicacionesUS WHERE ID = :ID");
      $sentencia->bindParam(':ID',$txtID);
      $sentencia->execute();
    ...
    <form action="" method="post" enctype="multipart/form-data">
      <div class="lado-1">  
        <div class="input-group">
          ...
          <img src="../../assets/post-img/<?php echo $nombreArchivo?>" alt="<?php echo $titulo;?>" id="preview">
      ...
      <div class="lado-2">
        ...
        <div class="input-group">
          ...
          <input value="<?php echo $titulo;?>" type="text" name="tituloUS" id="titulo" maxlength="150">
        </div>
        <div class="input-group">
          <label for="contenido">Contendio</label>
          <textarea name="contenidoUS" id="contenido">
            <?php echo $contenido;?>
          </textarea>
        </div>
        <div class="input-group">
          <label for="resumen">Resumen</label>
          <textarea type="text" name="resumenUS" id="resumen" maxlength="150"><?php echo trim($resumen);?></textarea>
        </div>

<?php
  ...
  if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO `publicaciones` (`ID`, `titulo`, `nom_imagen`, `fecha`, `contenido`, `resumen`) VALUES (NULL, :titulo, :nom_imagen, :fecha, :contenido, :resumen);");
